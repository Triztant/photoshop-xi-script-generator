...
// On form submit: build filename arrays & download the .jsx
document.getElementById('squadForm').addEventListener('submit', e => {
  e.preventDefault();

  // Helper to collect values from inputs by name
